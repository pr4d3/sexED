...
export default function HomePage() {
    ...
    const heroTitle = homeData?.hero_banner?.title || "Giáo dục Giới tính Chuẩn Khoa học";
    const heroSubtitle = homeData?.hero_banner?.subtitle || "Môi trường học tập an toàn, thân thiện và chuẩn y khoa, giúp gỡ bỏ những rào cản và ngần ngại trong việc tiếp cận kiến thức giới tính.";
                ...
                <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                    <div className="flex flex-col gap-6 md:gap-8">
                        <div className="inline-flex items-center gap-2 px-3.5 py-1.5 bg-primary-fixed text-on-primary-fixed-variant rounded-full w-fit shadow-sm">
                            ...
                            <span className="text-xs font-semibold">Được kiểm định bởi Chuyên gia Y tế</span>
                        </div>
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 pt-2">
                            <Link href="/courses" className="px-6 py-3.5 bg-primary text-white rounded-full text-sm font-bold hover:opacity-90 shadow-md flex items-center justify-center gap-2 transition-all">
                                Khám phá Khóa học
                                <span className="material-symbols-outlined text-white text-[18px]">arrow_forward</span>
                            </Link>
                            <Link href="/about" className="px-6 py-3.5 border border-outline/30 text-primary hover:bg-surface-container rounded-full text-sm font-bold flex items-center justify-center transition-all">
                                Tìm hiểu Đề tài
                            </Link>
                        </div>
                    </div>
                ...
                <div className="max-w-7xl mx-auto">
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        ...
                        <div className="flex flex-col items-center text-center p-8 bg-white/80 backdrop-blur-md rounded-3xl border border-white/60 shadow-sm hover-shadow transition-all duration-300">
                            ...
                            <h3 className="text-lg font-bold mb-3 text-on-surface">Chuẩn Y khoa</h3>
                            <p className="text-sm text-on-surface-variant leading-relaxed">
                                Nội dung được thẩm định bởi các bác sĩ và chuyên gia tâm lý hàng đầu, đảm bảo tính chính xác và an toàn tuyệt đối.
                            </p>
                        </div>
                        {/* Pillar 2 */}
                        <div className="flex flex-col items-center text-center p-8 bg-white/80 backdrop-blur-md rounded-3xl border border-white/60 shadow-sm hover-shadow transition-all duration-300">
                            ...
                            <h3 className="text-lg font-bold mb-3 text-on-surface">Thân thiện</h3>
                            <p className="text-sm text-on-surface-variant leading-relaxed">
                                Cách tiếp cận mềm mại, loại bỏ cảm giác ngần ngại, giúp người học dễ dàng tiếp thu những chủ đề nhạy cảm.
                            </p>
                        </div>
                        {/* Pillar 3 */}
                        <div className="flex flex-col items-center text-center p-8 bg-white/80 backdrop-blur-md rounded-3xl border border-white/60 shadow-sm hover-shadow transition-all duration-300">
                            ...
                            <h3 className="text-lg font-bold mb-3 text-on-surface">Cộng đồng An toàn</h3>
                            <p className="text-sm text-on-surface-variant leading-relaxed">
                                Môi trường thảo luận kín đáo, được kiểm duyệt nghiêm ngặt để bảo vệ sự riêng tư và tôn trọng cá nhân.
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <section className="py-24 px-4 md:px-16">
                <div className="max-w-7xl mx-auto flex flex-col items-center">
                    <div className="text-center mb-12">
                        <h2 className="text-2xl md:text-3xl font-extrabold text-on-surface mb-4">Lộ trình Học tập Chuyên biệt</h2>
                        <p className="text-sm text-on-surface-variant max-w-xl mx-auto">Lựa chọn chương trình phù hợp với độ tuổi và nhu cầu để có hiệu quả tiếp thu tốt nhất.</p>
                    </div>
                    ...
                    {loading ? (
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 w-full">
                            {coursesToRender.length === 0 ? (
                                <div className="col-span-full text-center py-12 text-on-surface-variant/75 text-sm">Chưa có khóa học nổi bật nào.</div>
                            ) : (
                                    ...
                                    >
                                        <div className="relative h-56 overflow-hidden p-2 pb-0">
                                            ...
                                            <div className="absolute top-6 left-6 px-3.5 py-1.5 bg-white/95 backdrop-blur-md rounded-full text-[10px] font-bold text-primary flex items-center gap-1.5 shadow-sm">
                                                <span className="material-symbols-outlined text-[14px]" style={{ fontVariationSettings: "'FILL' 1" }}>family_restroom</span>
                                                {activeTab === 'PARENT' ? 'Phụ huynh' : 'Học sinh'}
                                            </div>
                                        </div>
                                        <div className="p-8 flex flex-col flex-grow">
                                            <div className="flex gap-2 mb-4">
                                                <span className="px-2.5 py-0.5 bg-primary-fixed text-on-primary-fixed-variant rounded-full text-[10px] font-bold uppercase">Y khoa</span>
                                                <span className="px-2.5 py-0.5 bg-tertiary-fixed text-on-tertiary-fixed-variant rounded-full text-[10px] font-bold uppercase">Kiến thức</span>
                                            </div>
                                            ...
                                            <div className="mt-auto flex items-center justify-between pt-4 border-t border-outline-variant/20">
                                                <span className="text-xs text-on-surface-variant font-medium">Giảng viên: <strong className="font-bold text-on-surface">{course.instructor_name}</strong></span>
            ...
            <section className="py-24 bg-surface-container-low/30 px-4 md:px-16 relative border-t border-outline-variant/10">
                <div className="max-w-7xl mx-auto">
                    <div className="flex justify-between items-end mb-12">
                        <div>
                            <h2 className="text-2xl md:text-3xl font-extrabold text-on-surface mb-2">Thảo luận Cộng đồng</h2>
                            <p className="text-sm text-on-surface-variant">Không gian chia sẻ ẩn danh, an toàn và có kiểm duyệt.</p>
                        </div>
                        <Link className="hidden md:flex items-center gap-1 text-primary hover:text-primary-container font-semibold transition-colors text-sm" href="/forum">
                    ...
                    {loading ? (
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {!homeData?.recent_forum_posts || homeData.recent_forum_posts.length === 0 ? (
                                <div className="col-span-full text-center py-12 text-on-surface-variant/75 text-sm">Chưa có chủ đề thảo luận nào.</div>
                            ) : (
                                    ...
                                    >
                                        <div>
                                            <div className="flex items-center gap-4 mb-6">
                                                ...
                                                <div>
                                                    <p className="text-sm font-bold text-on-surface">{post.author_name || 'Thành viên ẩn danh'}</p>
                                                    <p className="text-[10px] text-on-surface-variant">{new Date(post.created_at).toLocaleDateString('vi-VN')}</p>
                                                </div>
                                            </div>
                                            ...
                                            <p className="text-xs text-on-surface-variant leading-relaxed mb-6 line-clamp-3">
                                                Mọi người thảo luận và đưa ra lời khuyên thiết thực dưới sự kiểm duyệt chuyên môn y văn.
                                            </p>
                                        </div>
                    ...
                    <div className="mt-10 text-center md:hidden">
                        <Link href="/forum" className="inline-flex px-8 py-3 border border-outline/30 text-on-surface rounded-full text-sm font-bold bg-white/50 backdrop-blur-sm shadow-sm hover:bg-white/80 transition-colors">
